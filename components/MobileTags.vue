...
<template>
	...
	>
		<h6 class="px-2 text-2xl font-bold text-neutral-950">Tags</h6>

		<div v-for="tag in tags" :key="tag" class="space-y-1">
			<button
				class="border-b border-neutral-200 w-full flex items-center gap-2 py-2.5 px-3 pb-4 cursor-pointer hover:bg-neutral-100 dark:hover:bg-neutral-800"
